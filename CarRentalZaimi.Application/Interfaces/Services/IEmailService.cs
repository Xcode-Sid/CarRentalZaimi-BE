...
public interface IEmailService
{
    ...
    Task<Result<bool>> SendNewCarNotificationEmailAsync(  string subscriberEmail, string carTitle, string carModel, string carYear, string fuelType, string seats,
        string pricePerDay, Guid carId, CancellationToken cancellationToken = default);
    Task<Result<bool>> SendNewPromotionNotificationEmailAsync(string subscriberEmail, string title, string code, string discountPercentage,
